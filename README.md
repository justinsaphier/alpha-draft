...
## Getting Started (once the repo is scaffolded)
...
cp .env.example .env   \# add your pricing API key here — never commit .env

flask db upgrade        \# run migrations once models exist

flask run

Adjust once the actual project structure and dependencies are locked in.  
